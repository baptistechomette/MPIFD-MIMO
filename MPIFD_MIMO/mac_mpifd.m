function[MAC] = mac_mpifd(vector1, vector2)
% Modal Assurance Criterion (MAC)
% judged uncorrelated when the MAC is lower than 0.6
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Authors :
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    num = diag(abs(vector1' * vector2)) ;
    den = vecnorm(vector1)' .* vecnorm(vector2)' ;
    MAC = (num ./ den).^2 ;
end
